...
def start_timer():
    ...
    elif reps % 2 == 0: #if 2nd, 4th, 6th rep
...
def count_down(count):
    ...
    if count > 0:
        ...
        for _ in range(mark_sessions):
            mark += "✔"
        checkmark_label.config(text=mark, font=(FONT_NAME, 20, "bold"))
...
start_button = Button(text="Calculate", bg=YELLOW, highlightthickness=0, command=start_timer)
